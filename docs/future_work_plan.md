...
## Add in Service Intake Page (need to decide if solo page or part of proposals, and then somehow add in separate coloring), possibly combine with Proposals (or change to bids...) -> could also be a separate table of tracking
## Update project board UI/UX and allow for manual task insertion or quote tracking
