      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          price_details: {
            ...
            paymentUponDrawings: quoteData.pricing.paymentUponDrawings,
            payment_upon_track_installation: quoteData.pricing.paymentUponTrackInstallation,
            paymentUponTrackInstallation: quoteData.pricing.paymentUponTrackInstallation,
            ...
            markup_percentage: quoteData.pricing.markup_percentage || 0,
            markup_margin: quoteData.pricing.markup_margin || 0,
            ...
            shipping_handling_subtotal: quoteData.pricing.shipping_handling_subtotal || 0,
            shipping_freight_subtotal: quoteData.pricing.shipping_freight_subtotal || 0,
            selling_price: quoteData.pricing.selling_price || 0
          },
