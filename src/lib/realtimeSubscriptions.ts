...
type TableName = 'quotes' | 'reminders' | 'projects' | 'organizations' | 'memberships' | 'subscriptions' | 'invite_tokens' | 'contacts' | 'profiles' | 'subscription_plans' | 'quote_activities' | 'project_tasks' | 'task_board_columns' | 'project_workflow_columns';
