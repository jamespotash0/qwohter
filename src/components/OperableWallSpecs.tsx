  ...
  const getPanelFinishSpecificItems = (category: string): string[] => {
    ...
    switch (category) {
      ...
      case "Standard Wood Veneer":
        return ["Unfinished Flat Cut White Maple", "Unfinished Flat Cut White Oak", "Unfinished Flat Cut Walnut", "Unfinished Flat Cut Cherry", "Unfinished Flat Cut Red Oak"];
