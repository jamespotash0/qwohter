        ...
        <Card key={wall.id}>
          ...
          <CardContent>
            <div className="space-y-6">
              {/* Dimensions Section */}
              <div>
                <h4 className="text-lg font-medium mb-4 text-gray-900">Dimensions</h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1">
                        ...
                        />
                        <Label className="text-xs text-gray-500 mt-1 block text-center">Feet</Label>
                      </div>
                      <div className="flex-1">
                        <Input
              ...
              <div>
                <h4 className="text-lg font-medium mb-4 text-gray-900">Track Details</h4>
