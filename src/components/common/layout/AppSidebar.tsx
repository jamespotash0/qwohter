...
import { House, FileText, ChartBar, Gear, Kanban, Sidebar as SidebarIcon, ArrowDownIcon, Lock, SignOutIcon, SquaresFour, Buildings, AddressBook, CheckSquare, CaretDown, Stack, CalendarBlankIcon, ClipboardText, Package } from "@phosphor-icons/react";
