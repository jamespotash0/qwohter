  ...
  return (
    <div className="rounded-md border">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-12 h-12 align-middle">
            ...
            <TableHead
              className="cursor-pointer hover:bg-muted/50 align-middle"
            ...
            <TableHead className="align-middle">Phone</TableHead>
            <TableHead
              className="cursor-pointer hover:bg-muted/50 align-middle"
              ...
              <TableCell className="text-center align-middle">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition-colors cursor-pointer">
