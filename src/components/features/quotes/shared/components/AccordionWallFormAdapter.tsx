...
import { AccordionWallFormFields } from './AccordionWallFormFields';

interface AccordionWallFormAdapterProps {
  wallName: string;
...
export const AccordionWallFormAdapter: React.FC<AccordionWallFormAdapterProps> = ({
  wallName,
  wall,
  ...
  const handleChange = (wallName: string, updates: Record<string, any>) => {
    if (onWallChange) {
