      ...
      if (existingQuote) {
        await updateQuote((existingQuoteData?.id as string), {
          ...
          price_details: {
            ...
            cost_markup_percentage: pricing.cost_markup_percentage || 0,
            ...
            material_cost_subtotal: pricing.material_cost_subtotal || 0,
            base_selling_price: pricing.base_selling_price || 0, // base_price: pricing.basePrice, 
            shipping_handlingFreight_subtotal: pricing.shipping_handlingFreight_subtotal || 0, // freight: pricing.freight,
            total_selling_price: pricing.total_selling_price || 0, // total: pricing.total
