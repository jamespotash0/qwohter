    ...
    <PageContent title="Team Management" subtitle="Manage your team members and their permissions" showPageHeader={true}>
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-[var(--content-card-bg)] shadow-[var(--content-card-shadow)] border-0 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_4px_20px_rgba(0,0,0,0.12)] cursor-pointer">
